...
import CalculationPayrollModal from "../modal/calculationPayrollModal";
...
export default function PayrollData() {
  ...
  const columns = React.useMemo(() => [
    ...
    { field: "perDaySalary", headerName: "Wage", width: 130 },
    {
      field: "actions",
      type: "actions",
      headerName: "Actions",
  ...
  return (
    <MDBox>
      <PayrollModal open={open} onClose={handleClose} />
      <Grid container>
